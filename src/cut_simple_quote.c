...
/*   Updated: 2023/06/29 18:30:15 by bastien          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cut_simple_quote_space(char *str, t_parsing *parsing, t_shell *shell)
{
	int	i;
	int	j;
...
void	ft_paste_simple_quote_space(char **str, t_parsing *parsing, t_shell *shell)
{
	int	i;
	int	j;
